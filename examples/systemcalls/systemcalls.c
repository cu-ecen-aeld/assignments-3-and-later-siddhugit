...
bool do_exec_redirect(const char *outputfile, int count, ...) {
    ...
    /*
     * TODO
     *   Call execv, but first using
     * https://stackoverflow.com/a/13784315/1446624 as a refernce, redirect
     * standard out to a file specified by outputfile. The rest of the behaviour
     * is same as do_exec()
     *
     */
    ...
    int logfd = open(outputfile, O_WRONLY | O_TRUNC | O_CREAT, 0644);
    if (logfd < 0) {
        perror("open");
        return false;
    }
